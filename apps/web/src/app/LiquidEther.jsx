...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    const resolvedColors =
      Array.isArray(colors) && colors.length > 0 ? colors : [color0, color1, color2];
    ...
    class CommonClass {
      ...
      init(container) {
        ...
        // Enable extension explicitly to avoid implicit-extension portability warnings.
      ...
      update() {
        ...
        this.delta = Math.min(0.05, Math.max(0, (now - this.lastTick) / 1000));
        this.lastTick = now;
...
`;
    ...
    class Advection extends ShaderPass {
      ...
      update({ dt: dtValue, isBounce: isBounceValue, BFECC: bfeccValue }) {
        this.uniforms.dt.value = dtValue;
        this.line.visible = isBounceValue;
    ...
    class Viscous extends ShaderPass {
      ...
      update({ viscous: viscousValue, iterations, dt: dtValue }) {
        let fbo_in;
        let fbo_out;
