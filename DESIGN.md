...
The candidate dashboard uses one dark hero with a subtle contour-line motif and closes with the wide career-journey illustration after application activity. The profile page uses one representative illustration to support the masthead; its quiet three-second motion plays once on page load or refresh, then holds on its final frame. Other candidate views are primarily functional and should not repeat the same artwork.
